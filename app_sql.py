...
def predict():
    ...
    if prediction==1:
        return render_template('main_pagge.html',prediction_text='This is a Phishing Website')
    else:
        return render_template('main_pagge.html',prediction_text='This is is a legitimate Website')
