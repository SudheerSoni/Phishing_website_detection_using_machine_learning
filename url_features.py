...
def extract_features(url):
    ...
    # Number of dots, hyphens, at symbols, question marks, ampersands, equal signs, underscores, tildes, percent signs, slashes, colons, commas, semicolons, dollar signs, spaces, 'www', 'com', double slashes
